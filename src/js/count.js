/* GoatCounter count.js, alojado en este mismo dominio en lugar de cargarse
   desde gc.zgo.at. Motivo: la politica de seguridad de contenido del sitio
   solo admite script propio (script-src 'self'), y asi ningun servidor de
   terceros puede ejecutar codigo en estas paginas.
   Licencia ISC, que permite redistribuirlo. Origen:
   https://gc.zgo.at/count.js  ---  copia tomada el 2026-08-19.
   Para actualizarlo: volver a descargar de esa URL y conservar esta cabecera. */
